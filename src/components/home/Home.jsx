      ...
      <Container bgColor="#fff8f1" maxW="100%">
        ...
        <Box width="70%" margin="auto">
          <Flex width="30%" margin="auto">
            <Image
              src="https://res.cloudinary.com/spiralyze/image/upload/v1657791092/Harvest/1029-Harvest-Home-Center-Align/Rate_stars_1.svg"
              margin="auto"
            />
            <Text>4.6</Text>
            <Text
          ...
          <Text
            ...
            marginTop="1.5rem"
          >
            Intuitive time tracking. Instant report generation. Automatic
            invoice creation.
          </Text>
          <Button
            bgColor="#fa5d00"
        ...
        >
          <Box>
            ...
            <Text fontSize="24px" marginTop="1rem">
              Create a project
            </Text>
            <Text
              fontSize="16px"
          ...
          <Box>
            ...
            <Text fontSize="16px" marginTop="0.5rem" color="#6d6e6d">
        ...
        <Box width="88%" margin="auto" textAlign="start" marginTop="4rem">
          <Text
            ...
            fontWeight="700"
            color="#fa5d00"
            fontFamily="MuotoWeb - 700"
          >
            FEATURES
          </Text>
          <Text
            fontSize="39px"
            fontFamily="MuotoWeb - 400"
            color="#1d1e1c"
            fontWeight="400"
          >
        ...
        >
          ...
          >
            <Image
              marginTop="0.5rem"
              src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/Harvest/1029-Harvest-Home-Center-Align/reports-and-analysis.png"
              width="3rem"
            />
            <Text
              marginTop="0.5rem"
          ...
          >
            <Image
              marginTop="0.5rem"
              src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/Harvest/1029-Harvest-Home-Center-Align/invoicing-and-payments.png"
              width="3rem"
            />
            <Text
              marginTop="0.5rem"
